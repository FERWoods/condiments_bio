.fateSelectionTest <- function(ws, conditions, global = TRUE, pairwise = FALSE,
...
setMethod(f = "fateSelectionTest",
          ...
          definition = function(cellWeights, conditions, global = TRUE,
            ...
            res <- .fateSelectionTest(ws = cellWeights, conditions = conditions,
...
setMethod(f = "fateSelectionTest",
          ...
          definition = function(cellWeights, conditions, global = TRUE,
            ...
            res <- fateSelectionTest(cellWeights = as.PseudotimeOrdering(cellWeights),
...
setMethod(f = "fateSelectionTest",
          ...
          definition = function(cellWeights, conditions, global = TRUE,
            ...
            res <- .fateSelectionTest(ws = ws, conditions = conditions,
                                      global = global, pairwise = pairwise,
                                      method = method, thresh = thresh,
                                      classifier_method = classifier_method,
                                      args_mmd = args_mmd, args_wass = args_wass,
